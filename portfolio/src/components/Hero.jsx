...
const Hero = () => {
  return (
    <section id="home" className="bg-[#0B1120] text-white max-w-7xl mx-auto px-6 md:px-16 py-16 flex flex-col md:flex-row items-center justify-between gap-12">
      ...
      <div className="md:w-1/2 flex flex-col items-start">
        ...
        <div className="flex flex-wrap gap-4 mb-10">
          <a 
            href="#projects"
            className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition duration-300 flex items-center gap-2"
          >
          ...
          <a 
            href="/resume.pdf" 
            download
            className="border border-gray-600 hover:border-gray-400 text-gray-300 px-6 py-3 rounded-lg font-medium transition duration-300 flex items-center gap-2"
          >
            Download Resume
          </a>
        </div>
